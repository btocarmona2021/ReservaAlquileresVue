...
<template>
  <div class="form__addusuario">
    <form action="" @submit="agregarUsuario">
      ...
      <input type="text" v-model="nombre" id="nombre" placeholder="Ingresa el nombre del usuario" />
      ...
      <input type="email" v-model="email" id="email" placeholder="Ingresa el email del usuario" />
