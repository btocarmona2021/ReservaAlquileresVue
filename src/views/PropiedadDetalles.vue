...
const obtenerPropiedad = async () => {
  try {
    ...
    propiedad.value?.opinions.reverse();
  } catch (error) {
    console.error(error);
  }
};
    ...
    if (Array.isArray(respuesta.data)) {
      reservas.value = respuesta.data.map((reserva) => ({
        ...
        endExclusive: new Date(
          new Date(reserva.fecha_fin).setDate(
            new Date(reserva.fecha_fin).getDate()
          )
        )
          .toISOString()
          .split("T")[0],
...
const calendarOptions = ref<optionCalendar>(<optionCalendar>{
  ...
  eventClassNames: function (arg: any) {
    ...
    if (arg.event.title.includes("pendiente")) {
      return ["fc-event--pendiente"];
    } else if (arg.event.title.includes("confirmada")) {
      return ["fc-event--confirmada"];
    }
    return [];
  },
    ...
    return {
      ...
      <div class="custom-event">
        <strong>${arg.event.title}</strong>
          ${arg.event.title === "confirmada" ? `<p>Señado / Pagado</p>` : ""}
      </div>
    `,
    };
  },
...
watch(reservas, (nuevasReservas) => {
  calendarOptions.value.events = nuevasReservas.map((reserva) => ({
    ...
    start: reserva.start,
      ...
      new Date(reserva.end).setDate(new Date(reserva.end).getDate() + 1)
    )
      .toISOString()
      .split("T")[0],
  }));
...
<template>
  <div class="propiedad">
    <div class="container-fluid d-flex">
      <div class="row d-flex justify-content-center">
        <div class="col-md-4 col-sm-12">
          <h1
            class="propiedad__titulo h3 text-center p-2 m-2 rounded-3"
            v-if="propiedad"
          >
            {{ propiedad.titulo }}
          </h1>
        ...
        <div class="col-md-3 col-sm-12 propiedad__comodidades mt-4">
          <p class="comodidad__titulo mb-3 fw-bold text-primary">
          ...
          <div class="d-flex flex-wrap gap-3">
            ...
            >
              ...
              />
              <span
                class="comodidad-nombre text-center"
        ...
        <div class="col-md-4 col-sm-12 tarifas mt-4">
          <p
            v-if="propiedad?.tarifas?.length"
            class="comodidad__titulo mb-3 fw-bold text-primary"
          >
            Tarifas disponibles
          </p>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center mb-2">
                    ...
                    <span class="text-muted"
                      >Calificación: {{ opinion.calificacion }}</span
                    >
                  </div>
                  <!-- Comentario -->
    ...
    <div class="container-fluid">
      <div class="row d-flex justify-content-center align-items-center mx-auto">
        ...
        <div class="col-md-4 reservas__info card p-4 shadow-lg rounded">
          ...
          <div class="reservas__ok" v-else>
            <p
              class="reservas__ok--contacto text-center fs-4 fw-bold text-success mb-4"
            >
            ...
            >
              ...
              <span
                ...
                <strong>{{
                  new Date(info.fecha_inicio).toLocaleDateString("es-ES", {
                    month: "long",
                  })
                }}</strong></span
              >
            ...
            >
              ...
              <span
                >Por un total de
                <strong>{{ info.dias_reserva }}</strong> días</span
              >
            </div>
            <div
              v-if="typeof info === 'object'"
            ...
            >
              ...
              <span
                ...
                <strong>{{ info.precio_total }}</strong> pesos</span
              >
            </div>
            <div
              v-if="typeof info === 'object'"
            ...
            >
              ...
              <span
                ...
                <span class="badge bg-warning text-dark ms-1 p-2">{{
            ...
            <div v-if="typeof info === 'object'">
              <p>
                <CurrencyDollarIcon class="icono__check text-success me-2" />
  ...
  <h1 class="header__titulos">
    <ChatBubbleLeftIcon class="icono__galeria" />
    Califícanos y recomiéndanos si lo consideras. ¡Gracias por tu visita! ¡Te
