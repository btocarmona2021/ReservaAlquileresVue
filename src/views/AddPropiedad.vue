...
const agregarPropiedad = async (ev: Event) => {
  ...
  datosPropiedad.append('capacidad_personas', capacidad_personas.value.toLocaleString());
...
<template>
  <div class="form__addcomodidad">
    <form action="" @submit="agregarPropiedad">
      ...
      <label for="imagen_principal">Carga la imagen principal de la propiedad</label>
      <input class="form-control" type="file" @change="actualizarImagen" id="imagen_principal" />
      ...
      <input class="btn btn-outline-dark" type="submit" value="GUARDAR PROPIEDAD" />
    </form>
  </div>
</template>
